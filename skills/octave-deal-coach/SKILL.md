...
description: Build a coaching plan or rehearsal grounded in buyer evidence and the active sales methodology, with optional Resonate/Elevate/Compel framing. Use for deal coaching, objection practice, coaching microsites, and buyer-readiness assessment. Route broad GTM onboarding to /octave-train and live opportunity action plans to /octave-pipeline.
...
Use the customer Motion methodology and evidence-based coaching focus. Explicit stage flags choose focus without asserting buyer readiness. Coach each relevant committee member. Route onboarding to train; retain deal rehearsal here.
...
- [coaching agents](references/coaching-agents.md)
- [coaching microsite sections](references/coaching-microsite-sections.md)
- [frameworks](references/frameworks.md)
- [html scaffold](references/html-scaffold.md)
- [messaging narratives](references/messaging-narratives.md)
