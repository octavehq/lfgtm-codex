...
```bash
bash <plugin-root>/skills/octave-asset-manager/scripts/download-artifact.sh --uuid <uuid> --out current
```
...
[asset script usage](../octave-asset-manager/references/script-usage.md): token in
...
```bash
bash <plugin-root>/skills/octave-asset-manager/scripts/update-artifact.sh --uuid <uuid> --src bundle \
...
```bash
bash <plugin-root>/skills/octave-asset-manager/scripts/upload-artifact.sh --src bundle \
