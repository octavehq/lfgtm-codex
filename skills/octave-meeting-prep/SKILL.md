...
Infer meeting type and duration. Use one content schema: context, goals, competitive, say-ask, objections, takeaway. The outline, HTML IDs, review, and delivery summary use meeting-sections.md. The scaffold supplies layout, not a second content schema.
...
- [meeting sections](references/meeting-sections.md)
- [output rules](references/output-rules.md)
- [positioning coach](references/positioning-coach.md)
- [strategic coach](references/strategic-coach.md)
