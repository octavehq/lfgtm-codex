...
Full system is the default when no focus is supplied. Support focused persona, messaging, homepage, or other requested lenses from the same strategy rows. Use supplied style or the inherited brand; ask only about unresolved choices. A narrow edit does not authorize rewriting every cell.
...
- [elevator pitches](references/elevator-pitches.md)
- [html scaffold](references/html-scaffold.md)
- [messaging framework](references/messaging-framework.md)
- [messaging matrix](references/messaging-matrix.md)
- [narrative arc](references/narrative-arc.md)
- [positioning statement](references/positioning-statement.md)
- [section layouts](references/section-layouts.md)
- [section templates](references/section-templates.md)
- [value prop hierarchy](references/value-prop-hierarchy.md)
